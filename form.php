...
$year=$_POST['year'];
$que=mysqli_query($conn,"insert into std_reg
(s_name,s_father,s_mobile,field,s_email,s_address,s_gender,standard,s_roll,
board,s_percent,pass_year)values
('$name','$fname','$mobile','$field','$email','$address','$gender','$standard',
'$roll','$board','$percent','$year') " );
}
...
$mpdf->WriteHTML($body);
$mpdf->Output("SMIU Admission Form.pdf","D");
?>